function [guardradpathleft,guardradpathright,guardanglePrev] = guardcaptureView(guard,guardanglePrev,roomnum)
%roomnum is equal to 0 if evader is at room1
%roomnum is equal to 1 if evader is at room2
[leftangle,rightangle] = GuardCapturePosition(guard,roomnum);
