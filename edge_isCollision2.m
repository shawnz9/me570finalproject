%function [flag]=hw1_edge_isCollision(vertices1,vertices2)
...
function [flag]=edge_isCollision2(vertices1,vertices2,varargin)

flagConsiderEndpointsAsCollisions=true;
tolDistance=1e-12;
tolParallel=1e-12;
...
if norm(diff(vertices1))<tolDistance || norm(diff(vertices2))<tolDistance
    flag=false;
else
